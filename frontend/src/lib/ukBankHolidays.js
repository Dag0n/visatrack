// England & Wales bank holiday calendar published by gov.uk
// (https://www.gov.uk/bank-holidays.json), used so "working day" calculations
// match UKVI's definition of processing time. Dates beyond the next year or
// so are gov.uk's forward calculated/estimated holidays — re-fetch from the
// source when this list runs out.
